...
public class WordKit extends WordConfig {
	...
	private static final LinkedHashMap<String, String> tableRelation = new // 表结构信息
    ...
    public void writeTableToWord(List<MySqlTable> tableList) throws Exception {
        ...
        log.debug("文件写入成功.");
        log.debug("成功将文件保存在>>>" + EXPORT_FILE_PATH);
    }
